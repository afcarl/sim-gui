...
database_location<-paste("D:\Benutzer\pharting\GUI1012\Exp111/its/Batch/",sep="")
# Path to the root directory plots.
plot_directory<-"D:\Benutzer\pharting\GUI1012\Exp111/Plots/"
...
boxplot<-0
boxplot_iteration_vector<-c( 250)
...
histogram_iteration_vector<-c( 250)
