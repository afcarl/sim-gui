	   ...
	   // setDefaultCloseOperation(JDialog.DO_NOTHING_ON_CLOSE);
		...
		editFilter.addActionListener( new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				filterDialog.setTitle("Filter for Agent "+agentJPanelList.get(tabbedPane.getSelectedIndex()).agent.agentName);
				...
				tempFilters = agentJPanelList.get(tabbedPane.getSelectedIndex()).agent.filter;
	   		...
	   		unSelectFilterVar.addMouseListener(new MouseListener(){
	   			...
	   			removeButton.addActionListener(new ActionListener(){
					...
					public void actionPerformed(ActionEvent arg1) {
						...
						for(int i=0; i< tempFilters.size();i++){
							...
							if(tempFilters.get(i).variableName.equals(dlm2Filter.get(index).toString())){
				...
				getContinued.addActionListener(new ActionListener(){
					...
					public void actionPerformed(ActionEvent arg0) {
						...
						agentJPanelList.get(tabbedPane.getSelectedIndex()).agent.filter = tempFilters;
			...
			VariableTable(PlottingSettings.Agent agentAtTab){
				...
				tabVariables.getColumnModel().getColumn(13).getCellEditor().addCellEditorListener(new EditorListener(){
					 ...
					 public void editingStopped(ChangeEvent e) {
						 ...
						 int editedrow = ((CellEditor) tabVariables.getColumnModel().getColumn(13).getCellEditor()).getRow();
